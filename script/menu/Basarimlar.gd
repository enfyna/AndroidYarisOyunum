...
func _ready():
	...
	if Global.kayit["tarih"]["toplamoynamasure"] < 3600000:
		...
		$S / V / B4 / H / Sag / ProgressBar.max_value = 3600000
	elif Global.kayit["tarih"]["toplamoynamasure"] < 36000000:
		Global.kayit["basarimlar"]["b2"] = 1
		$S / V / B4 / H / Sag / Label.text = tr("b8")
		$S / V / B4 / H / Sag / ProgressBar.value = Global.kayit["tarih"]["toplamoynamasure"]
		$S / V / B4 / H / Sag / ProgressBar.max_value = 36000000
	elif Global.kayit["tarih"]["toplamoynamasure"] < 360000000:
		Global.kayit["basarimlar"]["b2"] = 2
		$S / V / B4 / H / Sag / Label.text = tr("b9")
		$S / V / B4 / H / Sag / ProgressBar.value = Global.kayit["tarih"]["toplamoynamasure"]
		$S / V / B4 / H / Sag / ProgressBar.max_value = 360000000
