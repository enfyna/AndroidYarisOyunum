...
const musics : Array[String] = [
	"res://src/Sounds/BGM/Jazz/Kevin MacLeod-Airport Lounge.ogg",
	"res://src/Sounds/BGM/Jazz/Kevin MacLeod-Deuces.ogg",
	"res://src/Sounds/BGM/Jazz/Kevin MacLeod-Dirt Rhodes.ogg",
	"res://src/Sounds/BGM/Jazz/Kevin MacLeod-Hustle.ogg",
	"res://src/Sounds/BGM/Jazz/Kevin MacLeod-Samba Isobel.ogg",
]
