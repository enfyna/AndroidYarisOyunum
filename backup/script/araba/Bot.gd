...
func harekethesapla():
	gaz()
	sagsol()
	node.position.z = -15 + clamp(speed/10-brake_val*5,0,30)
	front.target_position.z = 5 + speed/10
...
func sagsol():
	...
	kutuorigin2.global_position = origin
